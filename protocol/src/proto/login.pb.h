...
class signin_ret;
class signin_retDefaultTypeInternal;
extern signin_retDefaultTypeInternal _signin_ret_default_instance_;
class signup;
...
class signin_ret : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:login.signin_ret) */ {
 public:
  signin_ret();
  virtual ~signin_ret();

  signin_ret(const signin_ret& from);

  inline signin_ret& operator=(const signin_ret& from) {
    CopyFrom(from);
    return *this;
  }

  static const ::google::protobuf::Descriptor* descriptor();
  static const signin_ret& default_instance();

  static inline const signin_ret* internal_default_instance() {
    return reinterpret_cast<const signin_ret*>(
               &_signin_ret_default_instance_);
  }

  void Swap(signin_ret* other);

  // implements Message ----------------------------------------------

  inline signin_ret* New() const PROTOBUF_FINAL { return New(NULL); }

  signin_ret* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void CopyFrom(const signin_ret& from);
  void MergeFrom(const signin_ret& from);
  void Clear() PROTOBUF_FINAL;
  bool IsInitialized() const PROTOBUF_FINAL;
  ...
  void SharedDtor();
  void SetCachedSize(int size) const PROTOBUF_FINAL;
  void InternalSwap(signin_ret* other);
  private:
  inline ::google::protobuf::Arena* GetArenaNoVirtual() const {
    return NULL;
  }
  ...
  // @@protoc_insertion_point(class_scope:login.signin_ret)
 private:
